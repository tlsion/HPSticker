...
public class HPStickerView: UIView, UIGestureRecognizerDelegate {
    ...
    public weak var delegate: HPStickerViewDelegate? {
        didSet {
    ...
    public init(contentView: UIView) {
        ...
        self.contentView.frame = CGRect.init(x: kStickerHalfControlViewSize, y: kStickerHalfControlViewSize, width: frame.size.width, height: frame.size.height)
...
//        }
        ...
        self.rightBottomControl.image = HPStickerBundle.image(named: "HPSticker.bundle/btn_resize.png")
        ...
        self.leftTopControl.image = HPStickerBundle.image(named: "HPSticker.bundle/btn_delete.png")
        ...
        self.rightTopControl.image = HPStickerBundle.image(named: "HPSticker.bundle/btn_smile.png")
        ...
        self.leftBottomControl.image = HPStickerBundle.image(named: "HPSticker.bundle/btn_flip.png")
    ...
    func attachGestures() {
        ...
        // ResizeControl
        let singleHandGesture = HPStickerGestureRecognizer.init(target: self, action: #selector(handleSingleHandAction(gesture:)), anchorView: self.contentView)
...
// MARK: - Handle Gestures
    ...
    @objc func handleSingleHandAction(gesture: HPStickerGestureRecognizer) {
        var scale = gesture.scale;
        // Scale limit
        let currentScale: CGFloat = self.contentView.layer.value(forKeyPath: "transform.scale") as! CGFloat
        if (scale * currentScale <= kStickerMinScale) {
...
// MARK: - UIGestureRecognizerDelegate
    public override func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        if gestureRecognizer.view == self.rightBottomControl && gestureRecognizer.isKind(of: HPStickerGestureRecognizer.self) {
            if self.enableRightBottomControl {
                self.delegate?.stickerViewDidTapRightBottomControl(stickerView: self)
                return false;
            }
...
// MARK: - Property
    ...
    func setDelegate(delegate: HPStickerViewDelegate?) {
        let leftTopImage = self.delegate?.stickerView(stickerView: self, imageForLeftTopControl: CGSize.init(width: kStickerControlViewSize, height: kStickerControlViewSize))
        ...
        let rightTopImage = self.delegate?.stickerView(stickerView: self, imageForRightTopControl: CGSize.init(width: kStickerControlViewSize, height: kStickerControlViewSize))
        ...
        let leftBottomImage = self.delegate?.stickerView(stickerView: self, imageForLeftBottomControl: CGSize.init(width: kStickerControlViewSize, height: kStickerControlViewSize))
        ...
        let rightBottomImage = self.delegate?.stickerView(stickerView: self, imageForRightBottomControl: CGSize.init(width: kStickerControlViewSize, height: kStickerControlViewSize))
...
public protocol HPStickerViewDelegate: NSObjectProtocol {
    func stickerViewDidTapContentView(stickerView: HPStickerView)

    func stickerView(stickerView: HPStickerView, imageForLeftTopControl recommendedSize: CGSize) -> UIImage?

    func stickerViewDidTapLeftTopControl(stickerView: HPStickerView) // Effective when image is provided.

    func stickerView(stickerView: HPStickerView, imageForRightTopControl recommendedSize: CGSize) -> UIImage?

    func stickerViewDidTapRightTopControl(stickerView: HPStickerView) // Effective when image is provided.

    func stickerView(stickerView: HPStickerView, imageForLeftBottomControl recommendedSize: CGSize) -> UIImage?

    func stickerViewDidTapLeftBottomControl(stickerView: HPStickerView) // Effective when image is provided.

    func stickerView(stickerView: HPStickerView, imageForRightBottomControl recommendedSize: CGSize) -> UIImage?

    func stickerViewDidTapRightBottomControl(stickerView: HPStickerView) // Effective when image is provided.
}

public extension HPStickerViewDelegate {
    func stickerViewDidTapContentView(stickerView: HPStickerView) {}

    func stickerView(stickerView: HPStickerView, imageForLeftTopControl recommendedSize: CGSize) -> UIImage? { return stickerView.leftTopControl.image }

    func stickerViewDidTapLeftTopControl(stickerView: HPStickerView) {stickerView.removeFromSuperview()}
    
    func stickerView(stickerView: HPStickerView, imageForRightTopControl recommendedSize: CGSize) -> UIImage? { return stickerView.rightTopControl.image }

    func stickerViewDidTapRightTopControl(stickerView: HPStickerView) {}

    func stickerView(stickerView: HPStickerView, imageForLeftBottomControl recommendedSize: CGSize) -> UIImage? { return stickerView.leftBottomControl.image }

    func stickerViewDidTapLeftBottomControl(stickerView: HPStickerView) {}

    func stickerView(stickerView: HPStickerView, imageForRightBottomControl recommendedSize: CGSize) -> UIImage? { return stickerView.rightBottomControl.image }

    func stickerViewDidTapRightBottomControl(stickerView: HPStickerView) {}
}
